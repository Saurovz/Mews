...
[UsedImplicitly]
public class JobExecutionCleanerActivity(
    Domain.JobExecutionLifecycle.JobExecutionCleaner cleaner,
    IOptions<JobExecutionCleanerWorkflowConfiguration> options,
    IIncidentReporter incidentReporter)
{
    private const string ActivityName = "JobExecutionCleanup";
